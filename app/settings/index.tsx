...
export default function SettingsScreen() {
  const { university, setUniversity, setIsAuthenticated, themeOverride, setThemeOverride, language, setLanguage } = useApp();
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Card style={styles.sectionCard}>
          <SettingItem 
            ...
            value={theme === 'dark'} 
            type="toggle" 
            onValueChange={(val: boolean) => setThemeOverride(val ? 'dark' : 'light')}
          />
          <View style={[styles.divider, { backgroundColor: colors.border }]} />
          <SettingItem icon={Bell} title="Push Notifications" value={true} type="toggle" onValueChange={() => {}} />
          <View style={[styles.divider, { backgroundColor: colors.border }]} />
          <SettingItem 
            icon={Globe} 
            title="Language" 
            ...
            type="link" 
            onPress={() => {
              const nextLang = language === 'English' ? 'Yoruba' : language === 'Yoruba' ? 'Igbo' : language === 'Igbo' ? 'Hausa' : 'English';
        ...
        <Card style={styles.sectionCard}>
          ...
          <SettingItem 
            ...
            title="Help & Support" 
            type="link" 
            onPress={() => Alert.alert("Support", "How can we help you today? Contact us at support@schooli.ng")}
          />
        </Card>
