...
export default function PaymentsScreen() {
  ...
  const handleVerify = () => {
    ...
    Alert.alert(
      "Verify Receipt",
      "Point your camera at the receipt (Bank Teller or Departmental Receipt).",
      [
        { text: "Cancel", style: "cancel", onPress: () => setIsVerifying(false) },
        { 
          text: "Scan Now", 
          onPress: () => {
            setTimeout(() => {
              Alert.alert("Verification Success", "Your receipt has been scanned and verified. Your balance will be updated shortly.");
        ...
        <TouchableOpacity activeOpacity={0.9} onPress={handleVerify}>
          <Card style={[styles.verifyCard, { backgroundColor: colors.success + '10', borderColor: colors.success + '30' }]}>
            ...
            <View style={styles.verifyContent}>
              <Text style={styles.verifyTitle}>{isVerifying ? 'Verifying...' : 'Verify Hand-held Receipt'}</Text>
              <Text style={[styles.verifyDesc, { color: colors.secondaryText }]}>
                {isVerifying ? 'Scanning receipt data, please wait.' : 'Scan your bank teller or departmental receipt to verify.'}
              </Text>
            </View>
