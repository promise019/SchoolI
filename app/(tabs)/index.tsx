...
import { StyleSheet, ScrollView, TouchableOpacity, View as DefaultView, Image } from 'react-native';
...
export default function DashboardScreen() {
  const { userProgress, university, user, themeOverride } = useApp();
      ...
      >
        <View style={styles.topHeader}>
          <View style={styles.headerTitleWrap}>
            <Image source={avatarSource} style={styles.headerLogo} resizeMode="cover" />
            <View>
        ...
        <View style={styles.section}>
          ...
          <QuickAction 
            icon={Sparkles} 
            title="Study-Chat AI" 
            subtitle="Scan books & get help"
            onPress={() => router.push('/assistant/study-chat')}
            color="#8B5CF6"
          />
        </View>
      </ScrollView>
